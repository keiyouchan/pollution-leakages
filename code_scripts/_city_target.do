...
gen target = 10 
replace target = 15 if inlist(cityname , "广州市" "深圳市" "珠海市" "佛山市" "江门市" "肇庆市" "惠州市" "东莞市" "中山市") 
replace target = 20 if inlist(cityname , "上海市" "南京市" "无锡市" "常州市" "苏州市" "南通市" "扬州市" "镇江市" "泰州市" "杭州市" "宁波市" "嘉兴市" "湖州市" "绍兴市")
replace target = 25 if inlist(cityname , "北京市" "天津市" "石家庄市" "唐山市" "保定市" "廊坊市")
